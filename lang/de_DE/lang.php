...
$LANG['biller_id'] = "Gl&auml;ubiger Nr.";//1
$LANG['biller_name'] = "Gl&auml;ubigername";//1
$LANG['biller_sales'] = "Gl&auml;ubiger Umsätze";//1
...
$LANG['customise_settings'] = "Einstellungen ändern";//1
$LANG['dashboard'] = "Dashboard";//0
$LANG['database_backup'] = "Sicherung der Datenbank";//1
...
$LANG['dont_forget_to'] = "Nicht vergessen!";//0
...
$LANG['email_biller'] = "Email an Rechnunssteller";//1
$LANG['email_biller_after_cron'] = "Email an Rechnunssteller nach jeder Wiederholung";//1
$LANG['email_customer'] = "Email an Kunde";//1
$LANG['email_customer_after_cron'] = "Email an Kunde nach jeder Wiederholung";//1
$LANG['email_from'] = "Email von";//1
$LANG['email_quick'] = "Kurzmail";//1
$LANG['email_statement_as_pdf'] = "Email Aufstellung als PDF";//1
...
$LANG['export_doc'] = "Export als DOC";//1
...
$LANG['fax'] = "Fax";//1
$LANG['filter_by_dates'] = "Filter nach Datum";//1
...
$LANG['gross_total'] = "Gesamtbrutto";//1
$LANG['hello'] = "Hello";//0
$LANG['help'] = "Hilfe";//1
...
$LANG['invoice_id'] = "Rechnungsnummer";//1
$LANG['invoice_listings'] = "Rechnungsauflistung";//1
$LANG['invoice_number'] = "Rechnungsnummer";//1
$LANG['invoice_numbering_group'] = "Rechnungsnummernkreis";//1
...
$LANG['money'] = "Geld";//1
$LANG['monthly_sales_per_year'] = "Monatlicher Umsatz und Zahlungen pro Jahr";//1
$LANG['months'] = "Monate";//1
$LANG['more_info'] = "Mehr...";//1
$LANG['mysql4_features_disabled'] = "As you are using MySQL 4 some features have been disabled";//0
$LANG['name'] = "Name";//1
$LANG['need_help'] = "Benötigen Sie Hilfe?";//1
$LANG['new_inventory_movement'] = "Neue Inventarbewegung";//1
...
$LANG['no_payments'] = "Es sind keine Zahlungen erfasst. Klicken Sie oben auf 'Zahlungseingang verbuchen' um eine empfangene Zahlung einzugeben";//1
...
$LANG['payments_filtered_customer'] = "Nach Kunde filtern";//1
...
$LANG['processing'] = "Bitte warten ...";//1
$LANG['product'] = "Produkt";//1
$LANG['product_attributes'] = "Product Attributes";//0
$LANG['product_description'] = "Beschreibung";//1
$LANG['product_description_prompt'] = "Sie müssen eine Beschreibung für das Produkt geben";//1
...
$LANG['products_sold_customer_total'] = "Produktverk&auml;ufe je Kunden - Gesamt";//1
$LANG['products_sold_total'] = "Produktverk&auml;ufe - Gesamt";//1
...
$LANG['setup_add_customer'] = "Kunde hinzufügen --> ";//1
$LANG['setup_add_inv_pref'] = "Rechnungsvorgabe hinzufügen --> ";//1
$LANG['setup_add_products'] = "Produkt hinzufügen --> ";//1
$LANG['setup_add_taxrate'] = "Steuersatz hinzufügen --> ";//1
$LANG['setup_as_biller'] = "Setup yourself as biller, click ";//0
$LANG['setup_create_invoices'] = "Erste Rechnung erstellen --> ";//1
...
$LANG['show_only_unpaid_invoices'] = "Nur unbezahlte Rechnungen zeigen";//1
$LANG['simple_invoices'] = "Simple Invoices";//0
$LANG['simple_invoices_powered_by'] = "Powered by Simple Invoices";//0
$LANG['start_date'] = "Startdatum (YYYY-MM-DD)";//0
$LANG['start_date_short'] = "Startdatum";//0
$LANG['start_working'] = "Hier beginnen";//0
$LANG['state'] = "Bundesland";//1
$LANG['statement'] = "Aufstellung";//1
$LANG['statement_for_the_period'] = "Zahlungsaufstellung für Zeitraum";//1
$LANG['statement_of_invoices'] = "Zahlungsaufstellung";//1
$LANG['statement_summary'] = "Aufstellung gesamt";//1
$LANG['statements'] = "Aufstellungen";//1
...
$LANG['totals'] = "Endsumme";//1
$LANG['type'] = "Typ";//1
$LANG['unit_cost'] = "Einzelpreis";//1
...
$LANG['years'] = "Jahre";//1
$LANG['yes'] = "Ja";//1
$LANG['your_reports'] = "Ihre Berichte";//0
$LANG['zip'] = "PLZ";//1
